...
st.set_page_config(page_title="Campus Navigation 3D", page_icon="🗺️", layout="wide")
...
st.markdown('<div class="header"><h1>🏫 CampusMate — 3D Indoor+Outdoor Navigation</h1></div>', unsafe_allow_html=True)
